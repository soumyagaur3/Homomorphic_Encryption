...
print("\t ct1_1:", ct1[1])
print("")
print("<p class='ct2'>[+] Ciphertext ct2({}):".format(pt2))
print("")
print("\t ct1_0:", ct2[0])
print("\t ct1_1:", ct2[1])
print("</p>")
...
end_time = time.time()
print("<p class='dc1'>[+] Decrypted ct3(ct1 + {}): {}</p>".format(cst1, decrypted_ct3))
print("<p class='dc2'>[+] Decrypted ct4(ct2 * {}): {}</p>".format(cst2, decrypted_ct4))

print(f"<p class='otp'>\n\n\n\n\n\nExecution time: {end_time-start_time} seconds</p>")